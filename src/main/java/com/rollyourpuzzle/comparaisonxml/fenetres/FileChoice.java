...
public class FileChoice extends JFrame implements ActionListener{
	...
	/**
	 * Construction de la fenêtre permettant de
	 * sélectionner deux fichiers XML à comparer
	 */
	...
	public void actionPerformed(ActionEvent pActionEvent) {
		...
		if(source == lBtCompare){
			...
			try {
				StringBuffer lResultats = ComparaisonXML.comparaison(lFieldFile1.getText(), lFieldFile2.getText());
